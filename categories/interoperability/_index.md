...
| **2 - Foundational** | Interoperability strategy is not completely defined and formal. Some integration guidance is available but not maintained. |
...
|----|-------------|-------:|
| [`interop-strategy`](#interop-strategy) | Maintain PKI interoperability strategy | 3 |
| [`integration-guidance`](#integration-guidance) | Documented integration guidance | 1 |
| [`open-standards`](#open-standards) | Adoption and application of open standards | 3 |

## Details

<a id="interop-strategy"></a>

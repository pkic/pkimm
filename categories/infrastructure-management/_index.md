...
| **2 - Foundational** | Network and deployment infrastructure is documented and known by the infrastructure team. |
...
|----|-------------|-------:|
| [`infra-documentation`](#infra-documentation) | Network and deployment infrastructure is documented | 4 |
| [`network-segmentation`](#network-segmentation) | Separation and segmentation principles are applied | 3 |
| [`vulnerability-management`](#vulnerability-management) | Network vulnerability management is implemented and maintained | 3 |
| [`recovery-objectives`](#recovery-objectives) | Infrastructure recovery objectives controls | 1 |
| [`infra-review`](#infra-review) | Infrastructure activities are periodically reviewed | 2 |

## Details

<a id="infra-documentation"></a>

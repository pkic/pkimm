...
| **2 - Foundational** | The compliance responsibility is established and assigned. The organization is aware of the relevant laws, regulations, and standards that should be followed. |
...
|----|-------------|-------:|
| [`compliance-policies`](#compliance-policies) | Compliance policies are defined, implemented, and communicated | 3 |
| [`compliance-monitoring`](#compliance-monitoring) | A program to monitor compliance with the policies is established | 4 |
| [`compliance-responsibilities`](#compliance-responsibilities) | Responsibilities for the compliance are formally defined and assigned | 3 |
| [`regulatory-inventory`](#regulatory-inventory) | List of relevant laws, regulations, and standards, exist and is maintained | 5 |

## Details

<a id="compliance-policies"></a>

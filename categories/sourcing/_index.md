...
| **2 - Foundational** | Resource are identified and documented. The resources and their specification are not clearly defined, which can lead to misuse of resources. |
...
|----|-------------|-------:|
| [`resource-identification`](#resource-identification) | Resources are identified and documented | 5 |
| [`resource-definition`](#resource-definition) | Resources are clearly defined | 3 |
| [`resource-availability`](#resource-availability) | Availability of resources | 4 |
| [`resource-review`](#resource-review) | Resources are periodically reviewed | 3 |

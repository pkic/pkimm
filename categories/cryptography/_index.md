...
| **2 - Foundational** | Basic cryptographic rules exist, such as preferred algorithms or minimum key sizes. However, documentation is incomplete, visibility into cryptographic usage is limited, and cryptographic decisions are not consistently enforced. |
...
|----|-------------|-------:|
| [`crypto-terminology`](#crypto-terminology) | Cryptographic terminology and scope are defined and documented | 3 |
| [`crypto-algorithms`](#crypto-algorithms) | Cryptographic algorithms and parameters are documented and approved | 5 |
| [`crypto-protocols`](#crypto-protocols) | Cryptographic protocols and versions are documented and approved | 3 |
| [`crypto-visibility`](#crypto-visibility) | Visibility into cryptographic usage is established and maintained | 5 |
| [`crypto-lifecycle`](#crypto-lifecycle) | Cryptographic lifecycle and deprecation rules are defined | 4 |
| [`crypto-agility`](#crypto-agility) | Cryptographic agility is defined and governed | 5 |

## Details

<a id="crypto-terminology"></a>

...
| **2 - Foundational** | Automation is used for some tasks, however, it is not described and it is not reliable or repeatable. |
...
|----|-------------|-------:|
| [`automation-description`](#automation-description) | Process automation description | 3 |
| [`automation-monitoring`](#automation-monitoring) | Monitoring and auditing of automated process | 1 |
| [`exception-handling`](#exception-handling) | Incidents and exceptions handling | 1 |

## Details

<a id="automation-description"></a>

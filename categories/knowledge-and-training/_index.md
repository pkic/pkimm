...
| **2 - Foundational** | Training plan is defined, however, there is no responsibility for the execution of the plan. |
...
|----|-------------|-------:|
| [`training-plan`](#training-plan) | Establish training plan | 2 |
| [`personnel-training`](#personnel-training) | Responsible personnel receive training | 2 |
| [`security-awareness-training`](#security-awareness-training) | Perform security awareness training | 2 |
| [`education-plan`](#education-plan) | Establish education plan | 1 |
| [`knowledge-review`](#knowledge-review) | Periodically review knowledge | 2 |

## Details

<a id="training-plan"></a>

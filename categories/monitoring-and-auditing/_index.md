...
| **2 - Foundational** | Logs are collected, however, they are not reviewed, nor correlated with other records. |
...
|----|-------------|-------:|
| [`logging-requirements`](#logging-requirements) | Monitoring events and logging requirements are defined and documented | 4 |
| [`log-collection`](#log-collection) | Event logs from systems are collected | 4 |
| [`audit-trail`](#audit-trail) | Audit trail can be reconstructed from audit logs | 5 |
| [`event-monitoring`](#event-monitoring) | Monitoring of operational and security events is implemented | 5 |
| [`critical-event-alerting`](#critical-event-alerting) | Critical events are immediately alerted and resolved according to incident response plans | 3 |
| [`log-review`](#log-review) | Review of events and logs is periodically performed | 2 |

## Details

<a id="logging-requirements"></a>

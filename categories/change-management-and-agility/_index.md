...
| **2 - Foundational** | Change management does not have documented and followed structure and is often ad-hoc. Agility is not formally cosnidered, however, it is applied in some cases. |
...
|----|-------------|-------:|
| [`change-policy`](#change-policy) | The policy for change management and agility is documented | 4 |
| [`change-request`](#change-request) | Request for change structure is documented and followed | 3 |
| [`change-process`](#change-process) | The change management process is documented and implemented | 4 |
| [`agility-requirements`](#agility-requirements) | Requirements for agility are identified | 2 |
| [`change-mgmt-review`](#change-mgmt-review) | Change management and agility is periodically reviewed | 2 |

## Details

<a id="change-policy"></a>

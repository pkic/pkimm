...
| **2 - Foundational** | Responsibilities and roles for key management are defined. Key management is managed ad-hoc and there is no documentation and inventory of cryptographic keys maintained. |
| **3 - Advanced** | Key management and lifecycle is documented and maintained. Inventory of cryptographic keys and devices is available. Procedures are formally followed. |
...
|----|-------------|-------:|
| [`key-mgmt-roles`](#key-mgmt-roles) | Key management roles and responsibilities are documented and formally assigned | 2 |
| [`key-inventory`](#key-inventory) | Inventory of cryptographic keys is documented and maintained | 2 |
| [`device-inventory`](#device-inventory) | Inventory of cryptographic devices is documented and maintained | 1 |
| [`key-lifecycle`](#key-lifecycle) | Each cryptographic key is defined and has documented lifecycle procedures | 2 |
| [`key-mgmt-review`](#key-mgmt-review) | Key management is periodically reviewed and updated | 3 |

## Details

<a id="key-mgmt-roles"></a>

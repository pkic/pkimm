...
| **2 - Foundational** | Processes and procedures are formally defined and documented, but not in the full scope and fully implemented and followed. |
...
|----|-------------|-------:|
| [`process-scope`](#process-scope) | Scope of processes and procedure is aligned with policies | 4 |
| [`process-documentation`](#process-documentation) | Processes and procedures are formally documented and followed | 3 |
| [`bau-execution`](#bau-execution) | Recurring activities are executed on time | 5 |
| [`process-evidence`](#process-evidence) | Evidence from procedures is collected and maintained | 3 |
| [`process-improvement`](#process-improvement) | Processes and procedures are reviewed and updated | 2 |

## Details

<a id="process-scope"></a>

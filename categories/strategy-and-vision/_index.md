...
| **2 - Foundational** | Basic vision has been developed but not followed. The scope and business drivers are not fully documented and understood. |
...
|----|-------------|-------:|
| [`sponsor-support`](#sponsor-support) | Organizational sponsor and support | 3 |
| [`responsible-leadership`](#responsible-leadership) | Formal assignment of responsible leadership | 2 |
| [`scope-and-drivers`](#scope-and-drivers) | Scope and business drivers for PKI | 2 |
| [`architecture`](#architecture) | Architecture and design of the PKI | 1 |

## Details

<a id="sponsor-support"></a>
